...
path_coarse = r"datasets/BlueMarbleNG-TB_2004-12-01_rgb_360x180.TIFF"
...
band_data_coarse = [
    Maps.read_file.GeoTIFF(path_coarse, sel=dict(band=b)) for b in (1, 2, 3)]
rgb_coarse = [d["data"] / 255 for d in band_data_coarse]

m2 = m.new_layer("coarse")
m2.set_data(**band_data_coarse[0])
m2.set_shape.raster()
